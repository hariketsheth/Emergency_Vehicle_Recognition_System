...
<header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php"><img height="30" src="images/logo1.png" alt="Logo"></a>
                    <a class="navbar-brand hidden" href="./"><img height="30" src="images/logo1.png" alt="Logo"></a>
